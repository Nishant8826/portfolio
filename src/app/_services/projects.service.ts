...
export class ProjectsService {
  ...
  projects: project[] = [
    ...
    { id: 5, name: "Watsapp Clone", pictures: ["../../assets/w1.png", "../../assets/w2.png", "../../assets/w3.png", "../../assets/w4.png", "../../assets/w5.png", "../../assets/w6.png"], projectLink: "https://github.com/Nishant8826/watsapp_clone.git", liveLink: "https://watsapp-clone-client.vercel.app", summary: "A clone of WhatsApp featuring video uploading and playback, akin to a static YouTube platform.", description: "This project, named 'Watsapp Clone', focuses on user chat system. It utilizes technologies such as React, Node.js, OAuth2 for authentication, Socket.IO for real-time communication, and Material-UI for the user interface", tags: [Tag.REACT, Tag.NODEJS, Tag.OAuth2, Tag.SOCKETIO, Tag.MATERIALUI,] }
  ];
